...
export default Component.extend(ModalBase, {
  ...
  init() {
    this._super();
    console.log('In modal edit node template');
  },
  ...
  didReceiveAttrs() {
    ...
    console.log('in modal-edit-node-template driver: %s', driver)
    console.log('in modal-edit-node-template override: %s', override)
  ...
  driverObj: computed('driver', function() {
    let d = (get(this, 'availableDrivers').filterBy('name', get(this, 'driver'))[0]);

    console.log('Driver object: %s', d.hasUi);
